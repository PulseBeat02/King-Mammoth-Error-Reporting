...

{
  ...
  public static void main(String[] p_main_0_) {
    ...
    String s1 = (String)optionset.valueOf(optionspec7);
    String s2 = (String)optionset.valueOf(optionspec8);
    
    if ((!proxy.equals(Proxy.NO_PROXY)) && (isNullOrEmpty(s1)) && (isNullOrEmpty(s2))) {
    	
      // java.net.Authenticator.setDefault(new Main.1());
    	
    	System.out.println("Error With Proxy");
    ...
    com.google.gson.Gson gson = new GsonBuilder().registerTypeAdapter(PropertyMap.class, new PropertyMap.Serializer()).create();
